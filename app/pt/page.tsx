import ActionButton from "@/i18n/components/action-button";
import Footer from "@/i18n/components/footer";
import Navbar from "@/i18n/components/navbar";
import ProjectShowcase from "@/i18n/components/project-showcase";
import Sidebar from "@/i18n/components/sidebar";
import SkillOutline from "@/i18n/components/skill-outline";
import { Separator } from "@/i18n/components/ui/separator";
import WorkShowcase from "@/i18n/components/work-showcase";
        ...
        <div className="md:min-w-[65vh] min-w-full space-y-10">
          ...
          <section id="home" key="home" className="space-y-5">
            ...
            <div className="flex justify-between">
              <ActionButton actionText="Estou disponível" />
